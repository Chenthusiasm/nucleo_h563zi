...
/* USER CODE END EM */
extern osThreadId_t dynamicTaskHandle;
extern osThreadId_t staticTaskHandle;
extern osMessageQueueId_t dynamicQueueHandle;
extern osMessageQueueId_t staticQueueHandle;
