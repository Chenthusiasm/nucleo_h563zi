...
#define CLI_ENABLE_GREET    false               /* enable the uShell-STM32 default greeting */
#define CLI_ENABLE_CRLF     true                /* enable using \r\n instead of just \n */
#define CLI_ENABLE_USB      true                /* enable USB instead of UART interface */
...
#if CLI_ENABLE_USB
/**
 * @brief   Command line init for USB.
 */
void        cli_init(void);
#else
/**
